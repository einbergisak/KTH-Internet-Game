...
// Values below are configurable to change game layout
val MAIN_TABLE_OCCUPIES_ENTIRE_HEIGHT = true
val GAME_WIDTH = 1000
val GAME_HEIGHT = 500
val PLAYER_VEL = 2
val PLAYER_SIZE = 50
...
val MIN_X = 0
val MAX_X = GAME_WIDTH-1
val MIN_Y = 0
val MAX_Y = GAME_HEIGHT-1
val GAME_BOUNDS = Rect(Pos(MIN_X, MIN_Y), Pos(MAX_X, MAX_Y))
val FOODBOXES_PER_TABLE = 5
val SIDE_TABLE_HEIGHT = GAME_HEIGHT
